...
export const menuData: MenuCategory[] = [
  ...
  items: [
    ...
    { name: t('Teleća City šnicla', 'Veal City Schnitzel', 'City Kalbsschnitzel', 'شنيتسل سيتي بالعجل'), description: t('Teleća šnicla, pomfrit, tartar sos', 'Veal schnitzel, fries, tartar sauce', 'Kalbsschnitzel, Pommes, Tartarsoße', 'شنيتسل عجل، بطاطا مقلية، صلصة التارتار'), price: '21,00 KM' },
    ...
    { name: t('Chicken Nuggets', 'Chicken Nuggets', 'Chicken Nuggets', 'ناجتس الدجاج'), description: t('Pohovana piletina, pomfrit, tartar sos', 'Breaded chicken, fries, tartar sauce', 'Paniertes Hähnchen, Pommes, Tartarsoße', 'دجاج مقلي، بطاطا مقلية، صلصة التارتار'), price: '10,00 KM' },
