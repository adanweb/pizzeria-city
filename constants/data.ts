...
export const menuData: MenuCategory[] = [
  ...
  {
  id: 'pizzas-55cm',
  title: t('Pizze 55cm', 'Pizzas 55cm', 'Pizzen 55cm', 'بيتزا ٥٥ سم'),
  items: [
    { name: t('Margarita', 'Margarita', 'Margarita', 'Margarita'), price: '13 KM' },
    { name: t('Funghi', 'Funghi', 'Funghi', 'Funghi'), price: '15 KM' },
    { name: t('Capricciosa', 'Capricciosa', 'Capricciosa', 'Capricciosa'), price: '17 KM' },
    { name: t('Vesuvio', 'Vesuvio', 'Vesuvio', 'Vesuvio'), price: '17 KM' },
    { name: t('Vegetariana', 'Vegetariana', 'Vegetariana', 'Vegetariana'), price: '16 KM' },
    { name: t('Romana', 'Romana', 'Romana', 'Romana'), price: '17 KM' },
    { name: t('Quattro Stagioni', 'Quattro Stagioni', 'Quattro Stagioni', 'Quattro Stagioni'), price: '18 KM' },
    { name: t('Tonno', 'Tonno', 'Tonno', 'Tonno'), price: '18 KM' },
    { name: t('Quattro Formaggi', 'Quattro Formaggi', 'Quattro Formaggi', 'Quattro Formaggi'), price: '18 KM' },
    { name: t('Hawaii', 'Hawaii', 'Hawaii', 'Hawaii'), price: '17 KM' },
    { name: t('Mexicana', 'Mexicana', 'Mexicana', 'Mexicana'), price: '18 KM' },
    { name: t('City Special', 'City Special', 'City Special', 'City Special'), price: '20 KM' },
    { name: t('Chicken BBQ', 'Chicken BBQ', 'Chicken BBQ', 'Chicken BBQ'), price: '20 KM' },
    { name: t('City Piquant', 'City Piquant', 'City Piquant', 'City Piquant'), price: '20 KM' },
    { name: t('City City', 'City City', 'City City', 'City City'), price: '20 KM' }
  ]
},
  {
  id: 'cityfood',
