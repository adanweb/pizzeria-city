...
export const menuData: MenuCategory[] = [
  ...
  {
  id: 'cityfood',
  title: t('City Food', 'City Food', 'City Food', 'City Food'),
  items: [
    { name: t('Jager pileći', 'Jager pileći', 'Jager pileći', 'Jager pileći'), description: t('Pileća šnicla, jager sos, riža', 'Pileća šnicla, jager sos, riža', 'Pileća šnicla, jager sos, riža', 'Pileća šnicla, jager sos, riža'), price: '10 KM' },
    { name: t('Jager teleći', 'Jager teleći', 'Jager teleći', 'Jager teleći'), description: t('Teleća šnicla, jager sos, riža', 'Teleća šnicla, jager sos, riža', 'Teleća šnicla, jager sos, riža', 'Teleća šnicla, jager sos, riža'), price: '16 KM' },
    { name: t('Bečka šnicla', 'Bečka šnicla', 'Bečka šnicla', 'Bečka šnicla'), price: '15 KM' },
    { name: t('Bečka šnicla XXL', 'Bečka šnicla XXL', 'Bečka šnicla XXL', 'Bečka šnicla XXL'), price: '25 KM' },
    { name: t('Cordon blue', 'Cordon blue', 'Cordon blue', 'Cordon blue'), price: '17 KM' },
    { name: t('Teleći medaljoni', 'Teleći medaljoni', 'Teleći medaljoni', 'Teleći medaljoni'), description: t('Teleća šnicla, sir, pomfrit, pekarski krompir, tartar sos', 'Teleća šnicla, sir, pomfrit, pekarski krompir, tartar sos', 'Teleća šnicla, sir, pomfrit, pekarski krompir, tartar sos', 'Teleća šnicla, sir, pomfrit, pekarski krompir, tartar sos'), price: '21 KM' },
    { name: t('City šnicla', 'City šnicla', 'City šnicla', 'City šnicla'), price: '21 KM' },
    { name: t('Gurmanski City burger', 'Gurmanski City burger', 'Gurmanski City burger', 'Gurmanski City burger'), price: '10 KM' },
    { name: t('Lignje pohane', 'Lignje pohane', 'Lignje pohane', 'Lignje pohane'), price: '16 KM' },
    { name: t('Lignje na žaru', 'Lignje na žaru', 'Lignje na žaru', 'Lignje na žaru'), price: '16 KM' },
    { name: t('Piletina mozzarella', 'Piletina mozzarella', 'Piletina mozzarella', 'Piletina mozzarella'), price: '10 KM' },
    { name: t('Piletina 4 vrste sira', 'Piletina 4 vrste sira', 'Piletina 4 vrste sira', 'Piletina 4 vrste sira'), price: '10 KM' },
    { name: t('Piletina u bechamel sosu', 'Piletina u bechamel sosu', 'Piletina u bechamel sosu', 'Piletina u bechamel sosu'), price: '8 KM' },
    { name: t('Piletina u curry sosu', 'Piletina u curry sosu', 'Piletina u curry sosu', 'Piletina u curry sosu'), price: '8 KM' },
    { name: t('Pohovana piletina', 'Pohovana piletina', 'Pohovana piletina', 'Pohovana piletina'), price: '9 KM' },
    { name: t('Pastrmka', 'Pastrmka', 'Pastrmka', 'Pastrmka'), price: '13 KM' },
    { name: t('Oslić sa prilogom', 'Oslić sa prilogom', 'Oslić sa prilogom', 'Oslić sa prilogom'), price: '12 KM' },
    { name: t('Povrće na žaru', 'Povrće na žaru', 'Povrće na žaru', 'Povrće na žaru'), price: '7 KM' },
    { name: t('Šampinjoni na žaru', 'Šampinjoni na žaru', 'Šampinjoni na žaru', 'Šampinjoni na žaru'), price: '7 KM' },
    { name: t('Pepper steak', 'Pepper steak', 'Pepper steak', 'Pepper steak'), price: '19.5 KM' },
    { name: t('City tortilja', 'City tortilja', 'City tortilja', 'City tortilja'), price: '8 KM' },
    { name: t('Teleća jetrca + prilog', 'Teleća jetrca + prilog', 'Teleća jetrca + prilog', 'Teleća jetrca + prilog'), price: '12 KM' },
    { name: t('Teleće pečenje + prilog', 'Teleće pečenje + prilog', 'Teleće pečenje + prilog', 'Teleće pečenje + prilog'), price: '15 KM' },
  ]
},
  {
  id: 'soups',
