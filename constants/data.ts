...
export const menuData: MenuCategory[] = [
  ...
  items: [
    ...
    { name: t('Teleće krpice + kajmak', 'Veal Strips + Kajmak', 'Kalbsstreifen + Kajmak', 'شرائح العجل + قشطة'), price: '13,00 KM' },
    ...
    { name: t('Pileći file', 'Chicken Filet', 'Hähnchenfilet', 'فيليه دجاج'), price: '10,00 KM' },
    { name: t('Pileće krpice + kajmak', 'Chicken Strips + Kajmak', 'Hähnchenstreifen + Kajmak', 'شرائح دجاج + قشطة'), price: '13,00 KM' },
    ...
    { name: t('City pikant pljeskavica', 'City Spicy Patty', 'City Scharfe Patty', 'برجر حار من سيتي'), price: '10,00 KM' },
    { name: t('Hamburger', 'Hamburger', 'Hamburger', 'هامبرغر'), price: '8,00 KM' },
    { name: t('Chickenburger', 'Chickenburger', 'Chickenburger', 'برجر دجاج'), price: '8,00 KM' },
    { name: t('Cheeseburger', 'Cheeseburger', 'Cheeseburger', 'برجر بالجبنة'), price: '8,00 KM' },
  ...
  items: [
    ...
    { name: t('Frutti di Mare', 'Frutti di Mare', 'Frutti di Mare', 'ثمار البحر'), description: t('Pizza sos, sir, plodovi mora', 'Pizza sauce, cheese, seafood', 'Pizzasoße, Käse, Meeresfrüchte', 'صلصة بيتزا، جبن، مأكولات بحرية'), price: '26,00 KM' },
    { name: t('Quattro Formaggi', 'Four Cheese', 'Vier Käse', 'أربعة أجبان'), description: t('Pizza sos, sir, 4 vrste sira', 'Pizza sauce, cheese, 4 types of cheese', 'Pizzasoße, Käse, 4 Käsesorten', 'صلصة بيتزا، جبن، 4 أنواع من الجبن'), price: '26,00 KM' },
  ...
  items: [
    ...
    { name: t('Pohovana piletina', 'Breaded Chicken', 'Paniertes Hähnchen', 'دجاج مقلي'), description: t('Pohovana piletina, pomfrit, tartar sos', 'Breaded chicken, fries, tartar sauce', 'Paniertes Hähnchen, Pommes, Tartarsoße', 'دجاج مقلي، بطاطا مقلية، صلصة التارتار'), price: '9,00 KM' },
    ...
    { name: t('Pepper steak', 'Pepper Steak', 'Pfeffersteak', 'ستيك بالفلفل'), description: t('Goveđi steak sa biber sosom', 'Beef steak with pepper sauce', 'Rindersteak mit Pfeffersoße', 'ستيك بقري مع صلصة الفلفل'), price: '19,50 KM' },
    ...
    { name: t('Teleća jetrca + prilog', 'Veal Liver + Sides', 'Kalbsleber + Beilage', 'كبدة عجل + طبق جانبي'), description: t('Teleća jetra sa prilogom po izboru', 'Veal liver with side of choice', 'Kalbsleber mit Beilage nach Wahl', 'كبدة عجل مع طبق جانبي'), price: '12,00 KM' },
